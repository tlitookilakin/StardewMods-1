...
namespace Pathoschild.Stardew.Common.Integrations.BetterBeehouses
{
    ...
    {
        /// <summary>Gets if bees can work here.</summary>
        ...
        /// <summary>Returns the number of days to produce honey</summary>
        /// <returns>True if bees can work in this location</returns>
        public int GetDaysToProduce();

        /// <summary>Return the distance bees will search for flowers</summary>
        /// <returns>Tile Radius</returns>
        public int GetSearchRadius();

        /// <summary>Returns the value multiplier for honey from bee houses</summary>
